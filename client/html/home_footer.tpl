<ul>
    ...
    </span><li>Build <a class='version' href='https://github.com/udf/szurubooru/commits'><%- ctx.version %></a><%- ctx.isDevelopmentMode ? " (DEV MODE)" : "" %> from <%= ctx.makeRelativeTime(ctx.buildDate) %></li><span class='sep'>
